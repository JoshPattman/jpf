...
func (c *concurrentLimitedModel) Respond(ctx context.Context, messages []jpf.Message, opts ...jpf.ModelResponseOpt) (jpf.ModelResponse, error) {
	err := c.sem.Acquire(ctx, 1)
	if err != nil {
		return jpf.ModelResponse{}, err
	}
	defer c.sem.Release(1)
	return c.model.Respond(ctx, messages, opts...)
}
