...
func NewSubstringParser[T any](decoder jpf.Parser[T], substring func(string) (string, error)) jpf.Parser[T] {
...
// If an error is detected when getting the substring, [ErrInvalidResponse] is raised.
func NewSubstringAfterParser[T any](decoder jpf.Parser[T], separator string) jpf.Parser[T] {
